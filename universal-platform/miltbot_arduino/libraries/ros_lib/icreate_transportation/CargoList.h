#ifndef _ROS_icreate_transportation_CargoList_h
#define _ROS_icreate_transportation_CargoList_h
...
namespace icreate_transportation
{

  class CargoList : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "icreate_transportation/CargoList"; };

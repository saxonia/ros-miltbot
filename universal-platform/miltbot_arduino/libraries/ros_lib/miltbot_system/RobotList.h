#ifndef _ROS_miltbot_system_RobotList_h
#define _ROS_miltbot_system_RobotList_h
...
namespace miltbot_system
{
  ...
  class RobotList : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "miltbot_system/RobotList"; };
